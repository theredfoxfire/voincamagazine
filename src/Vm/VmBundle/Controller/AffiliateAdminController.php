...
class AffiliateAdminController extends Controller
{
	public function batchActionActivate(ProxyQueryInterface $selectedModelQuery)
	{
		...
		try{
			foreach($selectedModels as $selectedModel){
				...
				->setSubject('VoincaMagazine Api')
				->setFrom(array('app@voincamagazine.com' => 'App API'))
				->setTo($selectedModel->getEmail())
				->setBody(
					$this->renderView('VmVmBundle:Affiliate:email.txt.twig', array('affiliate' => $selectedModel->getToken())))
					;
	...
	public function activateAction($id)
	{
		...
		$affiliate = $em->getRepository('VmVmBundle:Affiliate')->findOneById($id);
		...
		try{
			...
			$message = \Swift_Message::newInstance()
				->setSubject('VoincaMagazine Api')
				->setFrom('knowledge@voincamagazine.com')
				->setTo($affiliate->getEmail())
				->setBody(
					$this->renderView('VmVmBundle:Affiliate:email.txt.twig', array('affiliate' => $affiliate->getToken())))
					;
