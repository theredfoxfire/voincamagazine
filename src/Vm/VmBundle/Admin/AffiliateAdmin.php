...
class AffiliateAdmin extends Admin
{
	...
	protected function configureListFields(ListMapper $listMapper)
	{
		$listMapper
            ...
            ->add('created_at')
            ->add('token')
            ->add('_action', 'actions', array( 'actions' => array('activate' => array('template' => 'VmVmBundle:AffiliateAdmin:list__action_activate.html.twig'),
                'deactivate' => array('template' => 'VmVmBundle:AffiliateAdmin:list__action_deactivate.html.twig'))))
        ;
	}
